...
**This analysis also assumes the bzunzip2 command is available to extract the data.**
...
if ( file.exists("data_dir/data")) {
    my_data <- read.csv("data_dir/data")
}
```
